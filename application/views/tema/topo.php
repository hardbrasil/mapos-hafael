  ...
  <ul>
    ...
    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
        <li class="submenu <?php if(isset($menuOs)){echo 'active open';};?>">
          ...
          <ul>
            <li><a href="<?php echo base_url()?>index.php/os/calendario"><i class="icon icon-calendar"></i> <span>Calendário</span></a></li>
            <li><a href="<?php echo base_url()?>index.php/os/gerenciar"><i class="icon icon-tags"></i> <span>Gerenciar</span></a></li>
          </ul>
        </li>
    <?php } ?>
