...
class Os extends CI_Controller {
    ...
    function calendario() {
        ...
        $this->data['ordensAtrasadas'] = $this->os_model->getOsAtrasadas();
        $this->data['ordensVencendo'] = $this->os_model->getOsVencendo();
        $this->data['ordensAbertas'] = $this->os_model->getOsAbertas();
        $this->data['ordensAndamento'] = $this->os_model->getOsAndamento();
        $this->data['ordensOrcamento'] = $this->os_model->getOsOrcamento();
        $this->data['ordensFinalizado'] = $this->os_model->getOsFinalizado();
        $this->data['view'] = 'os/calendario';
